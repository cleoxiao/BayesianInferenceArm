...
batch_name = "cody_onset_sim" # Defines folder name
save_results = True
param_grid = {
    "task_type": ["cody1990"],
    ...
    "r_target": [0.025],
    "proprioceptive_intervention_on_angle": [-40, -20, -10, 0.0],
    ...
    "prop_unit": ["rad"],
    "proprioceptive_offset_rad_j2":   [0.0, -10.0],
    "proprioceptive_offset_omega_j2": [0.0, -10.0],
