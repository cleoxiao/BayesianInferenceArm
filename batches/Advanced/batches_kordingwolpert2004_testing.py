...
batch_name = "kordingwolpert_comb_testing_4" # Defines folder name
save_results = True
param_grid = {
    ...
    "prop_rad_sigma": [0.85, 3.4],
    "prop_omega_sigma": [0.85, 3.4],
    "vis_p_sigma": [0.001],
...
allowed_pairs = [
    {"prop_rad_sigma": 0.85, "prop_omega_sigma": 3.4},
    {"prop_rad_sigma": 3.4, "prop_omega_sigma": 0.85},
]
...
reps_resample = 3 # repetitions per parameter setting, spread across different cores, e.g. if param_grid gives 3 combinations and reps = 4, then 12 cores will be used
