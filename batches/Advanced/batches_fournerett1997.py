...
batch_name = "fournerett1997_sim" # Defines folder name
save_results = True
param_grid = {
    ...
    "n_trials": [10],
    "r_target": [0.002],
    "visual_feedback_rotation": [0.0, -5, -10],
    "vis_p_sigma": [0.001],
...
save_cols = [ 
    ...
    'torque_j1', 'torque_j2', 'torque_j1_ff', 'torque_j2_ff', 'torque_j1_sigma_scaled', 'torque_j2_sigma_scaled',
