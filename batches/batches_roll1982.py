...
batch_name = "roll1982_sim1" # Defines folder name
save_results = True
param_grid = {
    # "apply_proprioceptive_noise": [False],
    "task_type": ["roll1982"],
    "max_time_per_trial": [16.0],
    "movement_target": [False],
    "j1_locked_angle": [30.0],   
    "deg_j2_hand_init": [90.0],
    "n_runs": [1],
    # "simulation_seed": [42],
    "n_trials": [1],
    "proprioceptive_offset_omega_j2": [10.0],
    "vis_p_sigma": [0.001],
    ...
    "ukf_external_force_noise_sigma_concurrent_vib": [0.01],
}

# allowed_pairs = [
#     {"prop_rad_sigma": 0.015, "prop_omega_sigma": 0.06},
#     {"prop_rad_sigma": 0.06, "prop_omega_sigma": 0.015},
#     {"prop_rad_sigma": 0.015, "prop_omega_sigma": 0.015},
