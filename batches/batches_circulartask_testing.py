...
batch_name = "circular_task_sim_testing7" # Defines folder name
save_results = True
param_grid = {
    ...
    # "proprioceptive_multiplier_omega_j1": [1.0, 1.3, 0.7],
    ...
    # "proprioceptive_multiplier_omega_j2": [1.0, 1.3, 0.7],
    "proprioceptive_feedback_rad": [True],
    "proprioceptive_feedback_omega": [False],
    "proprioceptive_intervention_bool": [True],
    "damping_factor_believed_offset_j1": [0.5],
    "damping_factor_believed_offset_j2": [0.5],
    "vis_p_sigma": [0.001],
